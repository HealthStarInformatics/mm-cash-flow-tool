...
export const toolOptions =  [
    {
        ...
        img: <i class='fas fa-piggy-bank'></i>,
        title: "Investments",
        desc: <>You've got an income <span>surplus</span> of <span>$489.38</span>.  Here are some resources to help put that money to work for you.</>,
